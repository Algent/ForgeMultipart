...
behavior to Java. `TypeRef.jName` delegates normalization while preserving its virtual Scala name read. The next
bounded candidate is `ScalaSignature.TypeRef.jDesc`, with characterization before extraction.
